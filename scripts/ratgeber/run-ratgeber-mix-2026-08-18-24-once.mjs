...
const migrationId = 'ratgeber-mix-2026-08-18-24'
...
await import('./run-ratgeber-mix-2026-08-18-24.mjs')
  ...
  col.updateOne(
    { _id: migrationId },
    {
      $set: {
        ...
        description: 'Gemischter Ratgeber-Cluster für den 18.–24.08.2026 eingespielt',
      },
    },
    { upsert: true },
  ),
